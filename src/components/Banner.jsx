...
export default function Banner() {
    return (
        <section className="lg:w-6/12 md:w-8/12 sm:w-11/12 sm:px-0 px-[10px] sm:mx-auto grid grid-cols-2 grid-rows-2  mb-6">
            <Title className={"col-start-1 col-end-2 row-start-1 row-end-2  text-[#7db7a9]"}>
                <p className="uppercase">mima mimo:</p>
                <p className="lg:leading-9 lg:w-[320px] xl:w-[350px] sm:w-[240px]">Làm sao để phát triển tài chính cá nhân?</p>
            </Title>
            <div
                className={
            ...
            <NormalText className={"lg:mt-8 md:mt-4 sm:mt-3 mt-1 font-[500]"}>
